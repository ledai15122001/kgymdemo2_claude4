      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div ref={headerRef} className="mb-12 flex flex-col gap-8 md:mb-16 md:flex-row md:items-end md:justify-between">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-[480px] pb-1 text-[15px] leading-[1.75] tracking-[-0.01em] text-[#75656A]">
              Những khoảnh khắc tập luyện thật tại K-GYM Lái Thiêu — từ buổi tập cá nhân đến không khí phòng gym mỗi ngày.
            </p>
          </div>
        ...
        <div className="mt-20 flex justify-center">
          <a
            ...
            className="bg-[#FF7372] px-10 py-4 text-[12px] uppercase tracking-[0.15em] text-[#0D0D0D] transition-colors duration-300 hover:bg-[#ff5a59] active:scale-95"
